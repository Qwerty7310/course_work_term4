...
// Объявление указателей на функцию обработчика окна
...
extern HWND pieTextBox[7][2];
extern TCHAR* pieText[7][2];
...
void DrawPieChart(HDC hdc, RECT rectClient); //рисование круговой диаграммы
void DrawTextOnPieChartPage(HWND hWnd, HDC hdc, RECT rectClient); // рисование текста
int getPieChartData();
